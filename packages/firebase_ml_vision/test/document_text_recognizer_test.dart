    ...
    group('$DocumentTextRecognizer', () {
      ...
      group('throws an exception when native API fails to', () {
        ...
        test('process an image', () async {
          ...
          expect(recognizer.processImage(image), throwsA(isA<PlatformException>().having((e) => e.toString(), 'message', contains(errorMessage))));
        });
        ...
        test('close', () async {
          ...
          expect(recognizer.close(), throwsA(isA<PlatformException>().having((e) => e.toString(), 'message', contains(errorMessage))));
        });
      });
        ...
        group('$VisionDocumentText', () {
          ...
          group('$DocumentTextParagraph', () {
            test('is valid after a valid reply', () async {
              ...
              expect(paragraph.recognizedBreak!.detectedBreakType, TextRecognizedBreakType.values[5]);
